...
pub mod consts {
    ...
    pub const DISPLAY_CENTER: Fixed = Fixed::const_from_int(crate::DISPLAY_SIZE as i32 / 2);
    pub const DISPLAY_RADIUS: Fixed = Fixed::const_from_int(crate::DISPLAY_CENTER as i32 - 10);

    pub const GOLDEN_RATIO: Fixed = Fixed::lit("1.618");
}

// calculate LUT for sine values for angles 0 to PI/2 (one quarter wave) at complie time
...
// sin calculation using Taylor series TODO: look at math_rs
